    ...
    const logos = [
        {
            ...
            assistants: [
                { name: 'Stacy Brenes Gamboa', phone: '6184-3874' }
            ],
        },
        {
            ...
            assistants: [
                { name: 'Gabriela Urbina Hernández', phone: '6294-6231' }
            ],
        },
        {
            ...
            assistants: [
                { name: 'Michelle Montero Quesada', phone: '6391-2374' }
            ],
        },
        {
            ...
            assistants: [
                { name: 'Alanis Cespedes Aguilar', phone: '6184-3721' }
            ],
        },
        {
            ...
            assistants: [
                { name: 'Ingrid Mora Segura', phone: '6391-2632' },
                { name: 'Priscilla Diaz Rodriguez', phone: '6465-6346' }
            ],
        },
        {
            ...
            assistants: [
                { name: 'Álvaro Ospina Beltrán', phone: '6097-2749' }
            ],
        },
    ];

    return (
        <div className="w-full max-w-7xl mx-auto text-left my-32 px-8 md:px-24">
                    ...
                    <div key={ index } className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300">
                        <div className="card-body p-6">
                            <div className="flex flex-col sm:flex-row items-center justify-start">
                                <div className="w-1/2 text-center mb-4 sm:mb-0 sm:mr-8">
                                    <img src={ logo.src } alt={ logo.heading } className="w-full max-w-48 mx-auto rounded-lg" />
                                </div>
                                <div className="w-full sm:w-1/2 text-left">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-1">
                                            <div className="badge badge-outline badge-sm">Asistente{ logo.assistants.length > 1 ? 's' : '' }</div>
                                            <div className="text-gray-600">
                                                { logo.assistants.map((assistant, assistantIndex) => (
                                                    <div key={ assistantIndex } className={ assistantIndex > 0 ? 'mt-2' : '' }>
                                                        <div className="text-gray-600">{ assistant.name }</div>
