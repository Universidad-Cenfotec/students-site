...
export const EducationModelSection = () => {
        ...
        <Box sx={ { width: '100%', height: 'auto', textAlign: { xs: 'center', md: 'left' }, my: '2rem', px: { xs: '2rem', md: '6rem' } } }>
            ...
            >
                <Box sx={ { width: { xs: '100%', lg: '45%' }, textAlign: 'left' } }>
                    <Typography variant="body1" sx={ { mx: { xs: 'auto', lg: 0 }, my: '2rem', lineHeight: 2 } }>
                        Un modelo educativo abarca diferentes elementos interrelacionados, como el proceso de construcción del conocimiento, la enseñanza, el aprendizaje y la evaluación. Estos elementos se combinan para proporcionar un marco integral que promueva un aprendizaje activo, significativo y efectivo en los estudiantes. Al adoptar este modelo, se busca fomentar el desarrollo de habilidades, competencias y actitudes que preparen a los estudiantes para enfrentar los desafíos de la sociedad actual y futura.
                    </Typography>
                </Box>
            ...
            >
                ...
                <Box sx={ { width: { xs: '100%', lg: '45%' }, textAlign: 'left' } }>
                    ...
                    <Typography variant="body1" sx={ { mx: { xs: 'auto', lg: 0 }, my: '2rem', lineHeight: 2 } }>
                        Esta modalidad permite a los estudiantes tener formación en vivo a través de videoconferencia, sin desplazarse. Aprovecha las ventajas de interactuar en tiempo real con docentes que usan metodologías efectivas como aprendizaje basado en proyectos y resolución de problemas. Combina sesiones sincrónicas obligatorias con la opción de revisar grabaciones para una experiencia educativa enriquecedora.
                    </Typography>
                    <Typography variant="body1" sx={ { mx: { xs: 'auto', lg: 0 }, my: '2rem', lineHeight: 2 } }>
                        <Box component="span" sx={ { color: 'primary.main', fontWeight: 'medium', lineHeight: 1 } }>Características:</Box>
                        <List sx={ { listStyleType: 'disc', ml: '2rem' } }>
                            ...
                            <ListItem sx={ { display: 'list-item' } }>
                                Tutorías virtuales en vivo disponibles para algunas áreas, apoyo de estudiantes avanzados.
                            </ListItem>
                        </List>
                    </Typography>
                </Box>
